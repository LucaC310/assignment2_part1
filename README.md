...
It works together with the [assignment_2_2024](https://github.com/CarmineD8/assignment_2_2024) package, which provides the **action server** responsible for robot motion control and obstacle avoidance.
